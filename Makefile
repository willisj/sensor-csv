...
CXX = g++ -std=gnu++11
required_libs = -I. -Isensor-gps -Isensor-imu -lpthread -pthread -lgps
dest = "/usr/local/bin"
...
sensor_csv: prepare_dirs $(gps_o) $(imu_o) sensor_csv.cpp
	$(CXX) $(required_libs) $(local_debug_flags) $(imu_o) $(gps_o) sensor_csv.cpp -o bin/sensor-csv 
